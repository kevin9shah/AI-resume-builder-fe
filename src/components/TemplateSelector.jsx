...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    { id: "classic", name: "Classic", preview: "classic preview" },
    { id: "modern", name: "Modern", preview: "modern preview" },
    { id: "minimal-image", name: "Minimal Image", preview: "Minimal image preview" },
    { id: "minimal", name: "Minimal", preview: "Minimal preview" },
  ];
