  ...
  return (
    <div>
      <>
        ...
        <section className="relative flex flex-col items-center bg-gradient-to-b from-sky-100 via-white to-orange-50 text-slate-800 text-sm pb-10 bg-top bg-no-repeat">
          <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
            ...
            <div className="hidden md:flex items-center gap-8 transition duration-500 border border-green-900 bg-green-950 px-10 py-3 rounded-full">
              <a
                href="#"
                className="text-sm text-slate-50 hover:text-green-600 transition"
              >
                Home
              </a>
              <a
                href="#products"
                className="text-sm text-slate-50 hover:text-green-6000 transition"
              >
                Products
              </a>
              <a
              ...
              <a
                href="#pricing"
                className="text-sm text-slate-50 hover:text-slate-300 transition"
              >
                Pricing
              </a>
            </div>
            ...
            <Link to="/app?state=register">
              <button className="hidden md:block bg-green-600 active:scale-95 hover:bg-green-700 transition px-6 py-2 text-slate-50 rounded-full cursor-pointer">
                Start free trial
              </button>
            </Link>
          ...
          <div
            ...
            className={`fixed inset-0 z-50 bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}
          >
          ...
          <h1 className="text-center text-4xl leading-tight md:text-6xl/18 mt-3 font-semibold max-w-2xl px-4">
            Land your Dream Job with{" "}
            <span className="text-green-500">AI powered</span> Resume
          </h1>
          <p className="text-center text-sm md:text-base/7 text-black max-w-md mt-2 px-4">
            Show the world what you’re building — big or small, every project
            matters!
          </p>
          ...
          <p className="text-slate-400 mt-20 md:mt-25">
